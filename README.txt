...
The .exe in the Executable folder will turn any files in the "Input" folder into a base64 conversion that scrapmechanic can understand. Copy the entire base64 string and put it into the ("data":"[Paste here]") section of a blueprint json file containing a memory block.
WARNING-------------------------------------------------------
